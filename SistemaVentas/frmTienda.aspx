            ...
            <div class="col-sm-12">
               <div class="card">
                  <div class="card-header">
                    Sedes de Tienda Sosa
                  </div>
                  <div class="card-body">
                        <div class="row">
                            <div class="col-sm-2">
                                <button id="btnNuevoTienda" type="button" class="btn btn-sm btn-success">Nueva sede</button>
                            </div>
                        </div>
                      <hr />
                        <div class="row mt-3">
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Datos de Nueva Sede</h5>
