            ...
            <div class="col-sm-12">
               <div class="card">
                  <div class="card-header">
                     Asignacion de Encargado a Producto
                  </div>
                  <div class="card-body card-compra p-2">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="card">
                                  <div class="card-body p-2">
                                      <h6 class="card-title mb-1">Encargado</h6>
                                      <div class="row">
                                          ...
                                          <div class="col-sm-4">
                                            <div class="form-group mb-0">
                                              <label for="txtRazonSocialProveedor" class="col-form-label col-form-label-sm">Encargado:</label>
                            ...
                            <div class="col-sm-6">
                                <div class="card">
                                  <div class="card-body p-2">
                                      <h6 class="card-title mb-1">Sucursal de Destino</h6>
                                      <div class="row">
                                ...
                                <div class="card">
                                  <div class="card-body p-2">
                                      ...
                                      <div class="row">
                                          ...
                                          <div class="col-sm-2">
                                            <div class="form-group mb-0">
                                              <label for="txtPrecioCompraProducto" class="col-form-label col-form-label-sm">Precio de Costo:</label>
                                              <input type="text" class="form-control form-control-sm model" id="txtPrecioCompraProducto" name="PrecioCompra" value="0">
                                            </div>
                                          </div>
                                          <div class="col-sm-2">
                                            <div class="form-group mb-0">
                                              <label for="txtPrecioVentaProducto" class="col-form-label col-form-label-sm">Precio de Venta:</label>
                       ...
                       <div class="row mt-2">
                           <div class="col-sm-12">
                               <div class="float-right">
                                    <button id="btnAgregarCompra" class="btn btn-primary btn-sm float-right" ><i class="fa fa-plus-circle" aria-hidden="true"></i> ASIGNAR
                                    </button>
                                </div>
                           </div>
                  ...
                  <div class="card-footer">
                      <div class="float-right">
                          <button id="btnTerminarGuardarCompra" class="btn btn-success btn-sm float-right"><i class="fa fa-shopping-cart" aria-hidden="true"></i> TERMINAR ASIGNACIÓN
                          </button>
                      </div>
                  </div>
                </div>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title">Encargados</h5>
